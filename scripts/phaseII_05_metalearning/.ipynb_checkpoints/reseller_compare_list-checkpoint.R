...
#     }
    ...
    for (i in seq(length(tld_registrars))){ # for each tld-reseller in reseller subsety
...
save(reseller_compare_list_51_n,  file="../../data/output/reseller_compare_list_seg2_rf_01_n")