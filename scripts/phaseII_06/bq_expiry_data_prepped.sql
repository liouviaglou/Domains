SELECT sub.renewal_type, sub.renewed_count, DATE(sub.Expiry_date) as expiry_date, DATE(sub.creation_date1) as creation_date,
...
FROM   (SELECT 'FirstTime'  AS renewal_type, 
        ...
        WHERE  n.mbg = 0 
               AND n.expiry_date >= '2020-10-06'
               AND n.expiry_date <= '2020-10-10' 
               AND n.period > 0 
        UNION ALL
        ...
        WHERE  n.mbg = 0 
               AND n.transaction_expiry >= '2020-10-06' 
               AND n.transaction_expiry <= '2020-10-10' 
               AND n.period > 0 
       ...
       left join (select domain_id, gibb_score, pattern_domain_count, pattern, 
            day_domains, sld_length, sld_type, sld_type2, 
                  from data_science.npv_prepped_data) as npv_prepped_data
