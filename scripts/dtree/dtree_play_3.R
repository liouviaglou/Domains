...
dim(rbindlist(test))
###########Train Model##################
# mus re-train on just 80% training data
...
plot(outputtree_04)
dev.off()
save(outputtree_04, file="../../data/output/dtree2/outputtree_04")
...
# Not Renewd     342065   40454
# Renewed          3652    3646
# 
# Sensitivity : 0.082676        
# Specificity : 0.989436  
