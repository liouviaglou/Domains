...
reseller_compare_list_01_10 = reseller_compare_list(reseller_list=reseller_list,
                             train_list = expiry_train_prepped_2_1,
                             test_list = expiry_test_prepped_2_1)
                             
save(reseller_compare_list_01_10,  file="../../data/output/reseller_compare_list_11_50")